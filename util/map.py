...
class World:
    def __init__(self, width, height, max_rooms, min_room_xy=1,
                 max_room_xy=3, rooms_overlap=False, random_connections=3, tiles=CHARACTER_TILES):
        self.width = width
        self.height = height
    ...
    def gen_tiles_level(self):
        ...
        for n in self.tiles_level:
            tiles.append([int(char) for char in n])
        list_rooms=[]
